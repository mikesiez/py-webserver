# Webserver services
## mike-server (main) & mike-minecraft for minecraft dashboard
...
#
## nginx reverse proxy
## crontab to take care of repetitive tasks such as clearing old sessions or making sure domain is u2d if using domain host.
